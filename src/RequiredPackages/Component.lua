do
    ...
    local Janitor = require(Package:WaitForChild("Janitor"));
    local Signal = require(Package:WaitForChild("Signal"));
    ...
    local function CreateHandler(ComponentDetails)
        ...
        NewHandler.ComponentAdded = Signal.new();
    ...
    return {
        ...
        CreateComponent = function (Framework: {any}, ComponentDetails: {any}) -- Passing framework so that I can sync to the internal system for Services.
            ...
            local function CreateComponent(Object: Instance)
                ...
                Handler.ComponentAdded:Fire(Component);
                return Component;
            end

            Handler._Janitor:Add(CollectionService:GetInstanceAddedSignal(Handler.Tag):Connect(CreateComponent), "Disconnect");
            ...
            for _, Instance in pairs(CollectionService:GetTagged(Handler.Tag)) do
                task.defer(CreateComponent, Instance);
            end
