do
    ...
    function CardinalSystem.new()
        ...
        self._Janitor:Add(self.Initialized:Connect(function()
            print('Initialized');
            self._Initialized = true;
        end), "Disconnect");

        self._Janitor:Add(self.Started:Connect(function()
            print('Started');
            self._Started = true;
        end), "Disconnect");
    ...
    function CardinalSystem:AddComponents(_Resources: Folder | {ModuleScript} | ModuleScript | nil, Descendants: boolean?)
        if _Resources ~= nil and typeof(_Resources) ~= "boolean" then
            for _, Object in pairs(Get(_Resources, Descendants)) do
                if Object and Object:IsA("ModuleScript") then
